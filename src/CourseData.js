...
const CourseData=[
    ...
    {
        id:4,
        title:"Own Your Web: Professional Website & Email",
    ...
    },
    {
        ...
        description:"Complete Advanced Web Developer Course, Beginner to Advanced Level. 6 in 1 Course Bundle with Practicals with Projects",
        price:30,
    ...
    },
    {
        ...
        description:"Start from the basics and go all the way to creating your own applications and games!",
        price:40,
        img:"https://i.imgur.com/uCbn2xd.jpg"
    },
    {
        id:9,
        title:"REST WCF Service in ASP.NET",
        description:"Learn how to build a RESTful WCF Service in an ASP.NET web application and call its methods with JQuery.",
        price:25,
